...
namespace Engine.Factories
{
    ...
    public static class ItemFactory
    {
        ...
        {
            // Weapons
            _standardGameItems.Add(new Weapon(1001, "Stick", 0, 1, 2, 
            ...
            _standardGameItems.Add(new Weapon(1003, "Wooden Club", 4, 1, 2, 
                "A heafty log with a tapered end."));

            // Enchantment
            _standardGameItems.Add(new GameItem(2001, "Small Red Jewel", 10,
                "A small red jewel that sparkles in the light."));
            _standardGameItems.Add(new GameItem(2002, "Small Green Jewel", 15,
                "A small green jewel that sparkles in the light."));
            _standardGameItems.Add(new GameItem(2003, "Small Purple Jewel", 34,
                "A small purple jewel that sparkles in the light."));
            _standardGameItems.Add(new GameItem(2010, "Binding Wrap", 55,
                "An irridescent set of binds used for enchanting."));

            // Potions
            _standardGameItems.Add(new GameItem(3001, "Basic Healing Potion", 6,
